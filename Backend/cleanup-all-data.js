...
async function cleanupAllData() {
    ...
    // Знаходимо всіх адмінів для інформації
    ...
    // Отримуємо ID адмінів для захисту
    const adminIds = admins.map(a => a._id);
    const adminEmails = admins.map(a => a.email.toLowerCase());

    let totalDeleted = 0;

    // 1. Видаляємо всіх студентів (не адмінів)
    ...
    // 3. Видаляємо всі коментарі (Comment)
    ...
    // 4. Видаляємо всі коментарі викладачів (TeacherComment)
    ...
    // 5. Видаляємо всі реакції (Reaction)
    ...
    // 6. Видаляємо всі обговорення (Announcement)
    ...
    // 7. Видаляємо всі репорти (Report)
    ...
    // 8. Видаляємо всі запити на зміну імені (NameChangeRequest)
    ...
    // 9. Видаляємо всі токени скидання пароля
    ...
    // 10. Видаляємо всі коди верифікації
    ...
    // 11. Видаляємо всі refresh токени
    ...
    // 13. Видаляємо всі заявки на профіль викладача
    ...
    // 14. Видаляємо всі профілі користувачів (UserProfile)
