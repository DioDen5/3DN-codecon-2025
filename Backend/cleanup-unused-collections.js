...
/**
 * Скрипт для видалення невикористовуваних колекцій з бази даних
 * Безпечно видаляє:
 * - reviews (модель Review не використовується)
 * - student_verifications (модель StudentVerification не використовується)
 */
