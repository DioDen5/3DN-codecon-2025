...
export const requestNameChange = async (nameData) => {
    try {
        const response = await http.post('/api/name-change/request', nameData);
...
export const getNameChangeStatus = async () => {
    try {
        const response = await http.get('/api/name-change/status');
        return response.data;
    } catch (error) {
...
export const cancelNameChangeRequest = async () => {
    try {
        const response = await http.delete('/api/name-change/cancel');
        return response.data;
    } catch (error) {
