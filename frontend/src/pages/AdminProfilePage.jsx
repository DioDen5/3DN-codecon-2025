                            ...
                            <div className="space-y-3">
                                {allModerationContent.length > 0 ? (
                                    allModerationContent.map((item, index) => (
                                        <div key={item._id} className="bg-gray-50 rounded-xl p-4 border border-gray-200 moderation-slide-in hover:moderation-glow transition-all duration-300" style={{ animationDelay: `${index * 0.1}s` }}>
