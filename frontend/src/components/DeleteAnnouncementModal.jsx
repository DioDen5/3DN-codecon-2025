            ...
            >
                ...
                <div className="px-6 py-6">
                    <div className="mb-6">
                        ...
                        {itemName && (
                            <div className="mt-4 p-4 bg-gradient-to-r from-red-50 to-red-100 rounded-xl border border-red-200 relative overflow-hidden comment-animate">
                                <div className="absolute top-0 right-0 w-16 h-16 bg-red-100/30 rounded-full -translate-y-8 translate-x-8"></div>
                                <div className="relative">
                                    <div className="flex items-center gap-2 mb-1">
                                        <div className="p-1 bg-red-200 rounded-lg">
                                            <svg className="w-3 h-3 text-red-600 planet-icon" fill="currentColor" viewBox="0 0 24 24">
