        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            ...
            <div 
                className={`absolute inset-0 bg-black/50 backdrop-blur-sm animate-backdrop-fade ${
                    isClosing ? 'animate-modal-slide-out' : ''
                }`}
                onClick={handleClose}
            />
            ...
            >
                ...
                <div className="px-6 py-6">
                    <div className="mb-6">
                        ...
                        {itemName && (
                            <div className="mt-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200 relative overflow-hidden">
